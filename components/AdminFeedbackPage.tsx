        ...
        <div className="flex items-center gap-8">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-white/60 text-xs">Manage Lifewood Feedback</p>
            </div>
          </div>
          ...
          <nav className="hidden md:flex items-center gap-2 ml-8">
            ...
            <a href="#admin-feedback" className="px-4 py-2 bg-white/10 text-white rounded-lg font-medium text-sm transition-colors">
              Feedback
            </a>
          </nav>
        </div>
