...
const InputField = ({ label, icon: Icon, ...props }: any) => (
  <div className="space-y-2">
    ...
    <div className="relative group">
      ...
      <input 
        {...props}
        className="w-full bg-white/[0.03] border border-white/10 focus:border-orange-500/50 focus:bg-white/[0.05] focus:shadow-[0_0_20px_rgba(251,146,60,0.05)] rounded-2xl py-4 pl-12 pr-4 outline-none text-white placeholder:text-white/10 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
      />
    </div>
  </div>
);
...
const SocialButton = ({ children, icon, onClick, disabled }: { children: React.ReactNode, icon: React.ReactNode, onClick?: () => void, disabled?: boolean }) => (
  <button 
    ...
    onClick={onClick}
    disabled={disabled}
    className="flex items-center justify-center gap-3 py-3 rounded-2xl border border-white/5 bg-white/[0.02] hover:bg-white/[0.05] hover:border-white/10 transition-all duration-300 group w-full disabled:opacity-50 disabled:cursor-not-allowed"
  >
    {icon}
          ...
          >
             ...
             <form className="space-y-4" onSubmit={handleLogin}>
                ...
                <div className="space-y-2">
                    ...
                    <div className="relative group">
                        ...
                        <input 
                            ...
                            placeholder="••••••••"
                            className="w-full bg-white/[0.03] border border-white/10 focus:border-orange-500/50 focus:bg-white/[0.05] focus:shadow-[0_0_20px_rgba(251,146,60,0.05)] rounded-2xl py-4 pl-12 pr-12 outline-none text-white placeholder:text-white/10 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                            value={password}
                ...
                <button 
                  type="submit"
                  disabled={loading}
                  className="w-full bg-orange-500 hover:bg-orange-400 text-black rounded-2xl py-4 font-bold transition-all mt-4 shadow-lg shadow-orange-500/20 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                >
             ...
             <div className="mt-8 text-center">
                <p className="text-white/40 text-sm">
                    ...
                    <button onClick={() => { setIsLogin(false); setError(null); }} className="text-orange-500 hover:text-orange-400 font-semibold ml-1 transition-colors">
                        Sign Up
                    </button>
                </p>
             </div>
          ...
          >
             ...
             <div className="mt-8 text-center">
                <p className="text-white/40 text-sm">
                    ...
                    <button onClick={() => { setIsLogin(true); setError(null); }} className="text-orange-500 hover:text-orange-400 font-semibold ml-1 transition-colors">
                        Sign In
                    </button>
                </p>
             </div>
